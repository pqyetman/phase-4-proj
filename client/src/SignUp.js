...
function SignUp({updateUser}) {
    ...
    const { username, password, employee_id } = formData
    ...
    return (<>
        ...
        <Container fluid>
            <Row className="justify-content-center">
                ...
                <FontAwesomeIcon style={{ padding: '50px' }} icon={faBuilding} size="9x" className="center" spin />
                    ...
                    <Card.Body>
                        ...
                        <h3 style={{ textAlign: "center",}}>Create an Account</h3>
                            ...
                            <Form.Group className="mb-3" >
                                ...
                                <Form.Control name="employee_id" placeholder="1-10" onChange={handleChange} />
                            </Form.Group>
                            <Button style={{ margin: '10px'}} variant="primary" type="submit">
                                Submit
                            </Button>
                        </Form>
                        <Button onClick = {()=> history.push(`/`) } style={{ margin: '10px'}} size="sm" variant="secondary" type="submit">
                                Sign In
                            </Button>
                    </Card.Body>
                </Card>
